...
def main():
    ...
    nb_of_neurons_per_layer = np.array([input_size, 32, 32, 1])  # Array with decreasing neurons for each layer
    ...
    learning_rate = 0.04
    momentum_turn = 0.7
    error_threshold = 0.05  # Define the error threshold for stopping
